<template>
    <div class="airpods2">
        <div class="freeMusic mg_au">
            <div class="txt">
                <svg class="apple-music-logo mg_au" viewBox="0 0 83 20" aria-label="Apple Music" role="text">
                    <path
                ...
                <h2>Get 6 months of Apple Music free with your AirPods.*</h2>
                <a href="">Learn more</a>
            </div>
            <div class="img">
...
.airpods2 {
    background: #fafafa;
    .freeMusic {
        @include flex(space-between, center, 4rem);
        padding: 5rem;
        width: 80%;
        .txt {
